...
class SettingsManager {
    ...
    setupEventListeners() {
        ...
        this.elements.responseModeSelect.addEventListener('change', () => {
    ...
    updateVoiceSettingsVisibility() {
        const isAudioEnabled = this.elements.responseModeSelect.value === 'audio';
        this.elements.voiceSettingsGroup.style.display = isAudioEnabled ? 'block' : 'none';
    }
